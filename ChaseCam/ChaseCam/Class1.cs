    ...
    public class RaceCam : Script
    {
        ...
        void HandleCam()
        {
            ...
            if (ChaseCamOn && nfsCam != null)
            {
                ...
                float antiCantSeeSlide = 0;// map(Math.Abs(Vector3.SignedAngle(Car.Velocity.Normalized, Car.ForwardVector, Car.UpVector)), 45f, 90f, 0f, 0.5f, true);
                ...
                else nfsCam.Direction = Vector3.Lerp(nfsCam.Direction, baseAim, Game.LastFrameTime*10);
